export const popupContents  = {
    about: {title: "About Me", text:`
      \u00A0\u00A0\u00A0\u00A0\u00A0I am a passionate Quality Assurance (QA) professional with a strong foundation in software testing and a growing interest in development.
      ...
      Education:
      - Bachelor of Engineering (B.E.) in Electrical and Electronics Engineering in
    ...
    skill1: { title: "Manual Testing", text: `Extensive experience in Manual Testing, performing functional, regression, integration, and exploratory testing across web and mobile applications.
    ...
    skill2: { title: "Database Testing", text: `Extensive experience in Database Testing, ensuring data integrity, consistency, and accuracy by validating backend database operations, including insertions, updates, and deletions.
    ...
    skill3: {title: "API Testing", text:`Proficient in performing API Testing using Postman to validate API responses, including GET, POST, PUT, DELETE requests, and ensuring APIs return the expected status codes, response times, and data.
    ...
    skill4: {title: "Payments Testing", text:`Extensive hands-on experience in Payments Testing across multiple payment methods including Credit Cards, PayPal, SEPA, iDEAL, Bancontact, and Apple Pay.
    ...
    skill5: {title: "Automation Testing", text:`Hands-on experience in developing and executing Automation Test Scripts using Selenium WebDriver with C#, following industry best practices like Page Object Model (POM) for reusability and maintainability.

    Automated critical functional and regression test cases for web applications, improving test coverage and reducing manual testing efforts.

    Integrated automation test suites into Azure DevOps CI/CD pipelines, triggering automated test executions on every build and deployment to ensure rapid feedback.

    Analyzed automated test results from CI/CD runs, differentiated between environment issues, flaky tests, and genuine product defects, and reported defects with detailed logs and screenshots.

    Actively learning Python for implementing future automation frameworks using Playwright for modern web app testing and JMeter for API and load testing to expand skill set into performance testing.

    Experience in debugging automation scripts, handling synchronization issues using explicit waits, and maintaining test scripts for ongoing application changes. 

    Skilled in working with version control systems like Git to manage and track automation code changes.`},


    skill6: {title: "Status Report Generation", text:`Hands-on experience in preparing and sharing daily, weekly, and sprint-end QA status reports using Azure DevOps dashboards and query results.
    ...
    skill7: {title: "Defect Tracking & Reporting", text:`Hands-on experience in defect tracking, logging, updating, and reporting using Azure DevOps and JIRA.
    ...
    skill8: {title: "Agile & Scrum Methodologies", text:`Hands-on experience working in Agile Scrum environments, actively participating in daily stand-ups, sprint planning, sprint grooming, sprint reviews, and retrospectives.
    ...
    skill9: {title: "Cross-Browser & Mobile Testing", text:`Hands-on experience in Cross-Browser Testing across major browsers like Chrome, Firefox, Safari, Edge to validate UI consistency, functionality, and responsiveness.
    ...
    skill10: {title: "Root Cause Analysis", text:`Hands-on experience performing Root Cause Analysis by analyzing logs and telemetry data using tools like Splunk and Azure Application Insights.
    ...
    skill11: {title: "Test Management", text:`Hands-on experience managing end-to-end test planning, test design, test execution, and defect tracking using Azure DevOps and JIRA.
    ...
    skill12: {title: "User Acceptance Testing", text:`Hands-on experience actively collaborating with business users during UAT cycles to understand reported issues, reproduce them, and assist in clarifying business requirements.
    ...
    project1: {title: "Roles and Responsibilities", text:`Worked as part of a Telecom project where I was responsible for Manual Testing, Functional Testing, Cross-Browser Testing, and Usability Testing.
    ...
    project2: {title: "Roles and Responsibilities", text:`Worked on the Onboard LMS project, where I was responsible for Manual Testing, Functional Testing, Database Testing, and API Testing.
    ...
    project3: {title: "Roles and Responsibilities", text:`Worked on an E-Commerce Website project, where I was responsible for Manual Testing, Functional Testing, Payments Testing, API Testing, Automation Testing, and Test Analysis.
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const textContentMap = {
      'home-desc': `Detail-oriented QA Engineer with 5+ years of experience in manual and automation testing. Skilled in
        test strategy design, defect tracking, and quality assurance best practices. Experienced in collaborating with cross-functional teams, and ensuring high-quality software delivery. Strong
      ...
      'about-desc': `I’m Shaukat Ansar, a passionate QA Engineer with over 5 years of experience in both manual and automation testing.
        ...
        'sk5': `Skilled in Selenium WebDriver automation with C#, using Page Object Model and integrating tests into Azure DevOps pipelines. Focused on functional/regression test automation, analyzing CI/CD results, and debugging synchronization issues.`,
